...
Subprojects are the top-level directories for shared code, Minecraft versions, and loader targets, such as `common`, `1.20.1-common`, `1.20.1-fabric`, `1.20.1-forge`, or `26.2-neo`.

| Changes affect...                            | Scope                                                                    |
|----------------------------------------------|--------------------------------------------------------------------------|
| A single subproject                          | Use that directory name, such as `fix(26.2-fabric): ...`                 |
...
```
feat(26.2-fabric): add config screen support
...
```
mdk(26.2-fabric): add config screen support
